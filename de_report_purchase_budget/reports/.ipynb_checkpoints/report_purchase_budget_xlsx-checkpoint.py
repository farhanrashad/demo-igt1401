                ...
                for line in id.purchase_budget_line:
                    ...
                    for po in po_lines:
                        ...
                        if po.date_order.month == 1:
                            ...
                            try:
                                if po.date_order:
                                    month = po.date_order.strftime("%B/%Y")
                                else:
                                    month = None
                            except:
                                month = None
                            ...
                            sheet1.write(row1, 3, month, format2)
                            ...
                            sheet1.write(row1, 10, used_qty, format2)
                            sheet1.write(row1, 11, used_amount, format2)
                            sheet1.write(row1, 12, available_qty, format2)
                            sheet1.write(row1, 13, available_amount, format2)

                            row1 = row1 + 1
                        
                        elif po.date_order.month == 2:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet2.write(row2, 3, month, format2)
                            ...
                            sheet2.write(row2, 10, used_qty, format2)
                            sheet2.write(row2, 11, used_amount, format2)
                            sheet2.write(row2, 12, available_qty, format2)
                            sheet2.write(row2, 13, available_amount, format2)

                            row2 = row2 + 1
                            
                        elif po.date_order.month == 3:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet3.write(row3, 3, month, format2)
                            ...
                            sheet3.write(row3, 10, used_qty, format2)
                            sheet3.write(row3, 11, used_amount, format2)
                            sheet3.write(row3, 12, available_qty, format2)
                            sheet3.write(row3, 13, available_amount, format2)

                            row3 = row3 + 1
                        
                        elif po.date_order.month == 4:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet4.write(row4, 3, month, format2)
                            ...
                            sheet4.write(row4, 10, used_qty, format2)
                            sheet4.write(row4, 11, used_amount, format2)
                            sheet4.write(row4, 12, available_qty, format2)
                            sheet4.write(row4, 13, available_amount, format2)

                            row4 = row4 + 1
                        
                        elif po.date_order.month == 5:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet5.write(row5, 3, month, format2)
                            ...
                            sheet5.write(row5, 10, used_qty, format2)
                            sheet5.write(row5, 11, used_amount, format2)
                            sheet5.write(row5, 12, available_qty, format2)
                            sheet5.write(row5, 13, available_amount, format2)

                            row5 = row5 + 1
                        
                        elif po.date_order.month == 6:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet6.write(row6, 3, month, format2)
                            ...
                            sheet6.write(row6, 10, used_qty, format2)
                            sheet6.write(row6, 11, used_amount, format2)
                            sheet6.write(row6, 12, available_qty, format2)
                            sheet6.write(row6, 13, available_amount, format2)

                            row6 = row6 + 1
                        
                        elif po.date_order.month == 7:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet7.write(row7, 3, month, format2)
                            ...
                            sheet7.write(row7, 10, used_qty, format2)
                            sheet7.write(row7, 11, used_amount, format2)
                            sheet7.write(row7, 12, available_qty, format2)
                            sheet7.write(row7, 13, available_amount, format2)

                            row7 = row7 + 1
                        
                        elif po.date_order.month == 8:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet8.write(row8, 3, month, format2)
                            ...
                            sheet8.write(row8, 10, used_qty, format2)
                            sheet8.write(row8, 11, used_amount, format2)
                            sheet8.write(row8, 12, available_qty, format2)
                            sheet8.write(row8, 13, available_amount, format2)

                            row8 = row8 + 1
                        
                        elif po.date_order.month == 9:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet9.write(row9, 3, month, format2)
                            ...
                            sheet9.write(row9, 10, used_qty, format2)
                            sheet9.write(row9, 11, used_amount, format2)
                            sheet9.write(row9, 12, available_qty, format2)
                            sheet9.write(row9, 13, available_amount, format2)

                            row9 = row9 + 1
                        
                        elif po.date_order.month == 10:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet10.write(row10, 3, month, format2)
                            ...
                            sheet10.write(row10, 10, used_qty, format2)
                            sheet10.write(row10, 11, used_amount, format2)
                            sheet10.write(row10, 12, available_qty, format2)
                            sheet10.write(row10, 13, available_amount, format2)

                            row10 = row10 + 1
                        
                        elif po.date_order.month == 11:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet11.write(row11, 3, month, format2)
                            ...
                            sheet11.write(row11, 10, used_qty, format2)
                            sheet11.write(row11, 11, used_amount, format2)
                            sheet11.write(row11, 12, available_qty, format2)
                            sheet11.write(row11, 13, available_amount, format2)

                            row11 = row11 + 1
                        
                        elif po.date_order.month == 12:
                            ############## For February #############
                            try:
                                dep = []
                                for department in id.department_ids:
                            ...
                            sheet12.write(row12, 3, month, format2)
                            ...
                            sheet12.write(row12, 10, used_qty, format2)
                            sheet12.write(row12, 11, used_amount, format2)
